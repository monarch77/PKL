<div class="modal" id="editModal">
    <div class="modal-content">
        ...
        <div class="modal-body">
            <form id="editKlaimForm" action="{{ route('klaim.update', $claim->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="form-group">
                    <input type="hidden" name="claim_id" value="{{ $claim->id }}" class="form-control">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="file" id="dokumen_pendukung" name="dokumen_pendukung[]" class="form-control" multiple>
                </div>
